...
public final class TestSportByStaticInnerClass {
	 ...
	 */
	final SportSocialNetworkUserImpl<User> dcassani = new SportSocialNetworkUserImpl<>("Davide", "Cassani",
		"dcassani", 53);
	final SportSocialNetworkUserImpl<User> becclestone = new SportSocialNetworkUserImpl<>("Bernie", "Ecclestone",
		"becclestone", 83);
	final SportSocialNetworkUserImpl<User> falonso = new SportSocialNetworkUserImpl<>("Fernando", "Alfonso",
		"falonso", 34);

	/*
	 * Alonso is a fan of soccer and bike and practices F1: add these sports to
	 * Alonso
	 * 
